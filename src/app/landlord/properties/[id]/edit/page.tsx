    ...
    const fetchProperty = async () => {
      ...
      try {
        ...
        setForm({
          ...
          transportationEnabled: Boolean(property.transportation?.enabled),
          transportationMode: property.transportation?.mode && property.transportation.mode !== 'none' ? property.transportation.mode : 'private',
          transportationProviderName: property.transportation?.providerName || '',
          transportationContact: property.transportation?.contact || '',
          transportationNotes: property.transportation?.notes || '',
        });
        setTransportSchedules(
          Array.isArray(property.transportation?.schedules)
            ? property.transportation.schedules.map((schedule: any) => ({
                routeName: schedule?.routeName || '',
                pickupFromResidence: schedule?.pickupFromResidence || '',
                departureToCampus: schedule?.departureToCampus || '',
                returnPickupFromCampus: schedule?.returnPickupFromCampus || '',
                arrivalAtResidence: schedule?.arrivalAtResidence || '',
