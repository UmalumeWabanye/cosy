          ...
          <Box sx={{ borderRight: { md: '1px solid' }, borderColor: 'divider', maxHeight: { xs: 220, md: 'unset' }, overflowY: 'auto' }}>
            {loading ? (
              ...
              <Box sx={{ p: 3, textAlign: 'center' }}>
                ...
                <Typography variant="body2" color="text.secondary">Open a property and message the owner to start chatting.</Typography>
              </Box>
            ) : (
              <Stack>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: 0 }}>
            {selectedConversation ? (
              ...
              <Box sx={{ p: 4, textAlign: 'center' }}>
                ...
                <Button sx={{ mt: 2, textTransform: 'none' }} onClick={() => router.push('/browse')}>Browse Properties</Button>
              </Box>
            )}
          </Box>
        </Paper>
