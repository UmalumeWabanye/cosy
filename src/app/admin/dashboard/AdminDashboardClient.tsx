...
export default function AdminDashboardClient() {
  ...
  // Simple client-side Error Boundary to catch rendering/runtime errors and
  // display them on the page so we can debug deployments where console
        ...
        return (
          <div className="min-h-screen p-8">
            <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-6 rounded shadow">
              ...
              <pre className="whitespace-pre-wrap text-sm bg-gray-100 dark:bg-gray-800 p-3 rounded">{String(this.state.error && this.state.error.stack)}</pre>
