        ...
        for (const file of newImages) {
          ...
          try {
            ...
            if (uploadResponse.data.imageUrl) {
              allImages.push(uploadResponse.data.imageUrl);
            }
          } catch (imgErr: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-8">
        <div className="mb-6">
          <Link href={`/admin/properties/${propertyId}`} className="text-primary hover:underline font-semibold">
            ← Back to Property
          </Link>
        </div>
          ...
          <form onSubmit={handleSubmit} className="card p-8 space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Min Rent (R) *</label>
                  <input
                    type="number"
                    name="minRent"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Max Rent (R) *</label>
                  <input
                    type="number"
                    name="maxRent"
            ...
            <div className="border-t pt-6">
              ...
              {imagePreviews.length > 0 && (
                <div className="mb-6">
                  <h4 className="font-medium text-gray-700 mb-3">New Images (To be uploaded)</h4>
                  <div className="grid grid-cols-3 gap-4">
            ...
            <div className="border-t pt-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  <h4 className="font-semibold text-gray-700">Room Types</h4>
                  <button
                    type="button"
            ...
            <div className="border-t pt-6">
              ...
              <p className="text-sm text-gray-500 mt-2">Uncheck to hide this property from students</p>
            </div>
